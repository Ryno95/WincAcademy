...
shortestCountries = min([length["Country Name Length"] for length in all_countriesDict])
shortestNameCountries = []
count = 0
while count < len(all_countriesDict):
    if all_countriesDict[count]["Country Name Length"] == shortestCountries:
...
# 2
# Find and print the countries with the highest amount of vowels
countryVowelsAmount = []
